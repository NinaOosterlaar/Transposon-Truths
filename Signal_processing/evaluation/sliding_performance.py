...
if __name__ == "__main__":
    ...
    input_folder = f"Signal_processing/results/sliding_mean/sliding_ZINB_CPD/theta1/{dataset_name}"
    data_file = f"Signal_processing/sample_data/{dataset_name}.csv"
    output_folder = f"Signal_processing/results/sliding_cpd_performance/ZINB_shift_theta1"
