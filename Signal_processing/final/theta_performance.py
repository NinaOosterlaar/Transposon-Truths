...
def process_theta_for_dataset(theta_value, dataset_id, data, true_cps, window_size, overlap, thresholds, 
    ...
    for threshold in thresholds:
        ...
        # Run ZINB_ref change point detection with specific theta
...
def process_single_dataset(dataset_id, theta_values, window_size, overlap, thresholds, base_folder, output_folder, n_workers=1):
...
def plot_precision_recall_with_errorbars(agg_results_df, output_folder, dataset_name="SATAY_synthetic"):
    ...
    for tol_type in tolerance_types:
        ...
        for theta_val in theta_values:
            ...
            recall_stds = theta_data['recall_std'].values
            precision_stds = theta_data['precision_std'].values
            ...
            ax.errorbar(recalls, precisions, 
                       ...
                       label=f'θ={theta_val:.2f} (AUC={pr_auc:.3f})',
...
def main():
    ...
    output_folder = "Signal_processing/final/results/theta"
    
    window_size = 80  # Fixed window size
