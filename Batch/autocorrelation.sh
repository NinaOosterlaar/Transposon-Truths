...
srun apptainer exec \
    ...
    --pwd /workspace \
    "$APPTAINER_IMAGE" \
    python Signal_processing/autocorrelation.py --folder_name "Data/distances_with_zeros" --max_lag 2000 $ZERO_FLAG --output_folder "Signal_processing/results/autocorrelation/uncombined" --plot